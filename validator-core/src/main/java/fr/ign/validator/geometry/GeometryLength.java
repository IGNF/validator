...
public class GeometryLength {
	...
	public static double getPerimeter(Geometry geometry, Projection projection) throws MismatchedDimensionException, FactoryException, TransformException {
	...
	private static Geometry getLocalProjection(Geometry geometry, Projection sourceProjecion) throws FactoryException, MismatchedDimensionException, TransformException {
	...
	private static Geometry getWGS84Projection(Geometry geometry, Projection projection) throws FactoryException, MismatchedDimensionException, TransformException {
