...
public class StringFixerOptions {
    ...
    public static void buildOptions(Options options) {
        ...
        {
            Option option = new Option(
                null, "string-simplify-common", false,
        ...
        {
            Option option = new Option(
                null, "string-simplify-charset", true,
        ...
        {
            Option option = new Option(
                null, "string-escape-controls", false,
        ...
        {
            Option option = new Option(
                null, "string-escape-charset", true,
