 ...
 * 
 * WARNING : validityDomain will probably be replaced by a lon,lat bounding box extracted from URI (current usage is for GpU)
 * 
 * @author MBorne
 *
 */
public class Projection {
	...
	/**
	 * URI (http://www.opengis.net/def/crs/EPSG/0/2154, http://registre.ign.fr/ign/IGNF/crs/IGNF/RGF93LAMB93, etc.)
	 */
	private String uri ;
	 ...
	 * 
	 * ex : "POLYGON((60000 6010000,60000 7130000,1270000 7130000,1270000 6010000,60000 6010000))"
	 */
