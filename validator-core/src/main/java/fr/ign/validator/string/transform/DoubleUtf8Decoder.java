...
public class DoubleUtf8Decoder implements StringTransform {
    ...
    /**
     * The first characters appearing if double encoding associated to minCodePoint
     * and maxCodePoint (optimized in order to avoid searching replacements for no
     * reason)
     */
