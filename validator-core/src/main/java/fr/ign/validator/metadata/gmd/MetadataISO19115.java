...
public class MetadataISO19115 implements Metadata {
    ...
    public List<OnlineResource> getLocators() {
        ...
        for (Element onlineResourceElement : onlineResourceElements) {
            ...
            // applicationProfile
            onlineResource.setApplicationProfile(
                findValue(
                    "./gmd:applicationProfile/*",
                    onlineResourceElement
                )
            );
            onlineResource.setApplicationProfileUrl(
                findValue(
    ...
    public List<Extent> getExtents() {
        ...
        for (Element geographicElementNode : geographicElementNodes) {
            ...
            if (westBoundLongitude == null && eastBoundLongitude == null && southBoundLatitude == null
