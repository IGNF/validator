 ...
 * 
 * @see <a href=
 *      "http://www.datypic.com/sc/niem21/e-gmd_RS_Identifier.html">gmd:RS_Identifier</a>
 * @see <a href=
 *      "http://kartenn.region-bretagne.fr/wiki/doku.php?id=pole_catalogage:guide_de_saisie:systeme_reference">Système
 *      de référence de la ressource (geobretagne)</a>
 *
 * @author MBorne
 *
 */
