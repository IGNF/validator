...
public class FileConverterTest {
	...
	public void testConvertShpLatin1ToCSV() throws IOException {
		...
		Assert.assertEquals("\"POINT (557311.155866353 6742836.60415676)\",Bâtiment agricole,,16,,,41269,2013/09/26,",
				lines.get(1));
	}
	...
	public void testConvertShpUtf8ToCSVBadCharset() throws IOException {
		...
		Assert.assertEquals("\"POINT (557311.155866353 6742836.60415676)\",BÃ¢timent agricole,,16,,,41269,2013/09/26,",
				lines.get(1));
	}
	...
	public void testConvertTabLatin1ToCSV() throws IOException {
		...
		Assert.assertEquals(60, lines.size());
		Assert.assertEquals("WKT,LIBELLE,TXT,TYPEPSC,NOMFIC,URLFIC,INSEE,DATAPPRO,DATVALID", lines.get(0));
		Assert.assertEquals("\"POINT (557311.156 6742836.604)\",Bâtiment agricole,,16,,,41269,2013/09/26,",
				lines.get(1));
	}
