...
public class CsvFileTest {
    ...
    /*
     * @Test public void testPrescriptionPct41003() throws IOException{ File srcFile
     * = new
     * File(getClass().getResource("/csv/PRESCRIPTION_PCT_41003.csv").getPath()) ;
     * CsvFile csv = new CsvFile(srcFile); csv.open(); assertEquals( 6, csv.size() )
     * ; csv.close(); }
     * 
     * @Test public void testZoneUrba41003() throws IOException{ File srcFile = new
     * File(getClass().getResource("/csv/ZONE_URBA_41003-utf8.csv").getPath()) ;
     * CsvFile csv = new CsvFile(srcFile); csv.open(); assertEquals( 6, csv.size() )
     * ; csv.close(); }
     */
