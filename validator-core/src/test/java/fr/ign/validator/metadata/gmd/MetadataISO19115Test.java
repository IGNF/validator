...
public class MetadataISO19115Test {
  ...
  public void testRegress03() {
...

    {
      ...
      assertEquals(
          "4.01898628193261,49.2429346596619,5.42439068264001,50.150576343463", extents.get(1).getBoundingBox().toString()
      );
    }
  ...
  public void testRegress05() {
...

    {
      ...
      assertEquals(1, extents.size());
      assertEquals(
          "2.048286199569702,42.691341400146484,0.4412877559661865,43.92110061645508", extents.get(0).getBoundingBox().toString()
      );
    }
