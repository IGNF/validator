...
public class GeometryLengthTest {
    ...
    @Test
    public void testPointLength() throws ParseException, MismatchedDimensionException, FactoryException, TransformException {
    ...
    @Test
    public void testLineStringLength() throws ParseException, MismatchedDimensionException, FactoryException, TransformException {
    ...
    @Test
    public void testPolygonLength() throws ParseException, MismatchedDimensionException, FactoryException, TransformException {
    ...
    @Test
    public void testWGS84PointLength() throws ParseException, MismatchedDimensionException, FactoryException, TransformException {
    ...
    @Test
    public void testWGS84LineStringLength() throws ParseException, MismatchedDimensionException, FactoryException, TransformException {
    ...
    @Test
    public void testWGS84PolygonLength() throws ParseException, MismatchedDimensionException, FactoryException, TransformException {
