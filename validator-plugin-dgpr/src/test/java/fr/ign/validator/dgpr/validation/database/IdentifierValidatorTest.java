...
public class IdentifierValidatorTest {
	...
	public void testUnicityFail() throws Exception {
		...
		Assert.assertEquals("Problème dans la table TEST : l'identifiant 'test_2' est présent 2 fois.", idError0.getMessage());
		Assert.assertEquals("Problème dans la table RELATION : l'identifiant 'relation_3' est présent 3 fois.", idError1.getMessage());
	}
