...
public class ReferenceActeSupJointureBuilder {
    ...
    public void run() throws Exception {
        ...
        /*
         * Recherche des fichiers decrivant les actes ACTE_SUP : idActe, nomFichier
        ...
        /*
         * Recherche des Generateur de servitude a mettre a jour Cat_Generateur_Sup_s :
         * idGen, idSup Formation de la jointure - idGen - nomFichier
         */
        ...
        /*
         * Recherche des Assiette de servitude a mettre a jour Cat_Assiette_Sup_s :
         * idAss, idGen
         */
     ...
     * @throws IOException
     */
    private void performJointure(File actesFile, File servitudesFile, List<File> generateursFiles,
        List<File> assiettesFiles) throws Exception {
        /*
