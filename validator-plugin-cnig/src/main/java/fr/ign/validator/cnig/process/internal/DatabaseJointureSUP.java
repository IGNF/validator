 ...
 * ASSIETTE files
 * 
 * TODO : rebase table insertion on Database.loadTable (requires renaming table
 * columns)
 * 
...
public class DatabaseJointureSUP {
    ...
    public void loadFileGenerateur(File generateursFile) throws Exception {
        ...
        PreparedStatement sth = getConnection().prepareStatement(
            "INSERT INTO generateur (id,id_servitude) VALUES (?,?)"
        );
    ...
    public void loadFileAssiette(File assiettesFile) throws Exception {
        ...
        PreparedStatement sth = getConnection().prepareStatement(
            "INSERT INTO assiette (id,id_generateur) VALUES (?,?)"
        );
