...
public class CnigErrorCodes {
    ...
    /**
     * To be removed in futur version (remove from CNIG MD requirements, converted
     * to INFO)
     */
    @Deprecated
    public static final ErrorCode CNIG_METADATA_IDENTIFIER_INVALID = ErrorCode.valueOf(
        "CNIG_METADATA_IDENTIFIER_INVALID"
    );
