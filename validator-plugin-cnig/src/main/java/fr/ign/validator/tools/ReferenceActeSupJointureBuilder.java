...
public class ReferenceActeSupJointureBuilder {
	...
	private void performJointure(File actesFile, File servitudesFile,
			List<File> generateursFiles, List<File> assiettesFiles) throws SQLException, IOException 
	{
		/*
	 ...
	 * @throws IOException 
	 */
	private void addColumnFichiers(DatabaseJointureSUP database, FileType fileType, File file) throws IOException{
		/*
